...
LEFT JOIN escala_maestra m ON m.itemId = p.escala_maestra_id
LEFT JOIN catalogo_escala_maestra_area a  ON a.itemId = m.area_id
LEFT JOIN catalogo_escala_maestra_categoria c ON c.itemId = m.categoria_id
