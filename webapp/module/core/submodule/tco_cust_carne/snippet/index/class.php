...
class Index extends Table {
    ...
    function obtenerTco(){
        ...
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
                ...
                WHERE u2.itemId= ".$_SESSION["memberId"]." and (u.itemId=".$_SESSION["memberId"]." or u2.rol_itemId=1 or u2.rol_itemId=4 or u2.rol_itemId=6)
    ...
    function item_delete($id){
        ...
        if($ver){
            ...
            $res = $this->item_delete_sbm($id,$campo_id,"tco_custodia_cuero");
        }
        return $res;
    }
