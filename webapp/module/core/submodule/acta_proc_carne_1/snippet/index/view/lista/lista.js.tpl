                ...
                columnDefs: [
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            if(full["estado"]==1){
                                ...
                                '<a href="http://localhost:3000/acta-carne/pdf/'+data+' "target="_blank" class=" m-portlet__nav-link btn m-btn m-btn--hover-warning m-btn--icon m-btn--icon-only m-btn--pill " title="View">'+
