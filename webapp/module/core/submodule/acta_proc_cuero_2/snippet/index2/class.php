...
class Index extends Table {
    ...
    function obtenerTco(){
        ...
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
                ...
                FROM  usuario u2,responsable_curtiembre t1
                LEFT JOIN usuario u on u.itemId=t1.usuario_itemId
                WHERE u2.itemId= ".$_SESSION["memberId"]." and (u.itemId=".$_SESSION["memberId"]." or u2.rol_itemId=1 or u2.rol_itemId=6)
            ...
            if($idItem!=''){
                if($tipoTabla=='tipo'){
                    ...
                    $sqlFrom = ' acta_cuero i
                             ...
                             ';
                    $sqlWhere = ' i.itemId='.$idItem.' and (u3.rol_itemId=1 or u3.rol_itemId=4) and u3.itemId='.$_SESSION["memberId"];
    ...
    function item_delete($id){
        ...
        if($ver){
            $res = $this->item_delete_sbm($id,$campo_id,"acta_cuero");
        }
        return $res;
    }
