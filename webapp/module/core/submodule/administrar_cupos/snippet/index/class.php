...
class Index extends Table {
    ...
    function obtenerTco(){
        ...
        $this->dbm->SetFetchMode(ADODB_FETCH_ASSOC);
                $sql="SELECT  t1.tco_itemId,u2.rol_itemId
                FROM  usuario u2,representante_legal t1
                LEFT JOIN usuario u on u.itemId=t1.usuario_itemId
                WHERE u2.itemId= ".$_SESSION["memberId"]." and (u.itemId=".$_SESSION["memberId"]." or u2.rol_itemId=1)
    ...
    function item_delete($id){
        $campo_id="itemId";
        $res = $this->item_delete_sbm($id,$campo_id,"gestion_tco");
        return $res;
    }
