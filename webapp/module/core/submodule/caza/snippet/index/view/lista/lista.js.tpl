                        ...
                        render: function(data, type, full, meta) {
                            ...
                            var boton = ''+
                                    {/literal}{if $privFace.editar == 1}{literal}
                                        '<a href="'+direccionAPI+'caza/pdf/'+data+'" target="_blank" class="btn m-btn--hover-success m-portlet__nav-link btn m-btn m-btn--icon m-btn--icon-only m-btn--pill " title="View">'+
                                        '<i class="la flaticon-download m--font-brand"></i>'+
                                        '</a>'+
                                    {/literal}{/if}{literal}
