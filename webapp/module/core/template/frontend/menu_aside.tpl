<div id="m_ver_menu"
    ...
    <ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow " style="padding: 0px;">
        ...
        {foreach from=$menu_modulo_principal item=row key=idx}
            ...
            <li class="m-menu__item m-menu__item--submenu {if $miga.padre.catalogo_itemId  == $row.itemId } m-menu__item--open m-menu__item--expanded m-menu__item--hover{/if}"
            ...
            <div class="m-menu__submenu ">
                ...
                <ul class="m-menu__subnav">
                    ...
                    {foreach from=$row.submenu item=submenu key=sidx}
                        <li class="m-menu__item {if $miga.smodulo.carpeta == $submenu.submodulo}m-menu__item--active{/if}"
                            aria-haspopup="true" style=" border-bottom: 1px dashed #484b66;">
                            <a class="m-menu__link "
                                    {if $submenu.tipo == 'INDEX'}
                                        href="index.php?module=core&smodule={$submenu.submodulo}" {if $submenu.target}target="_blank"{/if}
