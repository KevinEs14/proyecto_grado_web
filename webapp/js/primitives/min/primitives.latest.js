...
/* /common/init.js*/
/**
 * @preserve Basic Primitives Diagram v5.0.0
...
(function () {
	...
	primitives.common.version = "5.0.0";
}());
...
primitives.famdiagram.FamilyLayout.prototype.findOptimalSize = function (thisArg, maximum, funcCheckSize) {
	...
	if (!funcCheckSize.call(thisArg, minimum)) {
		if (funcCheckSize.call(thisArg, maximum)) {
			cursorIndex = maximum;
...
/*
	Function: primitives.famdiagram.Control
...
primitives.common.BaseConnectorBundle.prototype.traceAngularSegments = function (data, params, options, bundlePoint, points, drawToBundle) {
	...
	for (index = 0, len = points.length; index < len; index += 1) {
		...
		data.graph.addEdge(bundlePoint.id, point.id, new this.ConnectorEdge(bundlePoint.id, point.id, polyline, null, isVisible ? point.id : null, isVisible ? 1000.0 : 10));
	}
};
...
primitives.orgdiagram.ActiveItemsTask = function (itemsSizesOptionTask, readTemplatesTask) {
	...
	function process() {
		...
		for (index = 0, len = items.length; index < len; index += 1) {
			...
			if (isActive) {
				_data.items[itemConfig.id] = true;
			}
		}
		return true;
	}
...
/*
	Function: primitives.orgdiagram.Control
	Constructs Organizational Diagram Control. 
...
/* /Widgets/orgdiagram/Templates/jQueryButtonsTemplate.js*/
...
/* /Widgets/orgdiagram/orgDiagram.js*/
/*
 * jQuery UI Diagram
 *
...
/* /Widgets/famdiagram/famDiagram.js*/
/*
 * jQuery UI Diagram
 *
