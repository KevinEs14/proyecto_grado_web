/*
 Basic Primitives Diagram v5.0.0
...
primitives.common.ArrayReader.prototype.read=function(a,b,c,d){var e=[],f={},g,h,i={},j={},k,m,l,n,p,q=c+"-seq";if(!b||!primitives.common.isArray(b))b=[];g=d.hash[c]||{};h=d.hash[q]||{};l=0;for(n=b.length;l<n;l+=1)k=b[l],m=this.containsUniqueItems?this.containsPrimitiveValues?k:k[this.uniquePropertyKey]:l,f.hasOwnProperty(m)||(p=this.itemTemplate.read(g[m]||{},k,c+"-"+l,d),e.push(p),f[m]=p,i[l]=m,this.createSourceHash&&(j[m]=k),this.isOrdered&&h[l]!=i[l]&&(d.isChanged=!0));d.hash[c]=f;d.hash[q]=i;
...
this.getLevelVisibilities(this.params.treeLevels,this.options.minimalVisibility),d=this.setTreeLevelsVisibilityAndPositionTreeItems(e,this.params,this.options,c,c.length-1),d.addRect(a),d.offset(0,0,5,5),this.findOptimalSize(this,c.length-1,function(a){b=this.setTreeLevelsVisibilityAndPositionTreeItems(e,this.params,this.options,c,a);return this.checkDiagramSize(b,d,this.options.pageFitMode)})}this.data=e;return b};
...
primitives.famdiagram.FamilyLayout.prototype.findOptimalSize=function(a,b,c){var d=0,e;if(!c.call(a,d)&&c.call(a,b)){for(e=b;1<b-d;)e=Math.floor((b+d)/2),c.call(a,e)?b=e:d=e;b!==e&&c.call(a,b)}};
...
primitives.famdiagram.CursorNeighboursTask=function(a,b,c){function d(a,b,d){var c=[],e={};if(null!==a)switch(b){case 0:d.loopParents(this,a,function(a,b){e.hasOwnProperty(a)||(e[a]=!0,c.push(a));if(b.isActive)return d.SKIP});d.loopChildren(this,a,function(a,b){e.hasOwnProperty(a)||(e[a]=!0,c.push(a));if(b.isActive)return d.SKIP});break;case 1:d.loopNeighbours(this,a,function(a,b){e.hasOwnProperty(a)||(e[a]=!0,c.push(a));if(b.isActive)return!0})}return c}var e=[];return{process:function(){var f=a.getCursorTreeItem(),
...
m.y,!0,this,function(a,b,d,c){n.addSegment(new primitives.common.MoveSegment(a,b));n.addSegment(new primitives.common.LineSegment(d,c))});k=m.x==d.x?d.id:m.bundleid;p=4!==m.visibility;a.graph.addEdge(k,m.id,new this.ConnectorEdge(k,m.id,n,g&&p?m.id:null,!g&&p?m.id:null,null,p?1E3:10,h))}f=Math.max(f-1,0);j=Math.min(j+1,e.length-1);m=d;k=d.id;for(l=f;l<=j;l+=1)p=e[l],q=p.bundleid,p.x>m.x&&(n=new primitives.common.Polyline,b.transform.transformPoints(m.x,d.y,null!=p.elbowPoint2?p.elbowPoint2.x:p.x,
d.y,!0,this,function(a,b,d,c){n.addSegment(new primitives.common.MoveSegment(a,b));n.addSegment(new primitives.common.LineSegment(d,c))}),a.graph.addEdge(k,q,new this.ConnectorEdge(k,q,n,null,null,k,Math.abs(p.x-m.x)/1E4,h,i,g?q:k)),m=p,k=q);m=d;k=d.id;for(l=j;l>=f;l-=1)p=e[l],q=p.bundleid,p.x<m.x&&(n=new primitives.common.Polyline,b.transform.transformPoints(m.x,d.y,null!=p.elbowPoint2?p.elbowPoint2.x:p.x,d.y,!0,this,function(a,b,d,c){n.addSegment(new primitives.common.MoveSegment(a,b));n.addSegment(new primitives.common.LineSegment(d,
c))}),a.graph.addEdge(k,q,new this.ConnectorEdge(k,q,n,null,null,k,Math.abs(p.x-m.x)/1E4,h,i,g?q:k)),m=p,k=q)}else this.traceAngularSegments(a,b,c,d,e,!0)};
...
primitives.orgdiagram.ActiveItemsTask=function(a,b){var c={};return{process:function(){var d=a.getOptions(),e=d.items,f,g;c={};f=0;for(g=e.length;f<g;f+=1){var h=e[f],i=b.getTemplate(h.templateName,d.defaultTemplateName,b.DefaultWidgetTemplateName).templateConfig;h.isActive&&i.isActive&&(c[h.id]=!0)}return!0},getActiveItems:function(){return c}}};
...
primitives.orgdiagram.VisualTreeTask=function(a,b,c,d){function e(a,b,c){var e,g,s,v,u,B,D,H,G,I,K,E,O={},J,U={},L,R,S,V={},T;a.loopPostOrder(this,function(a,b,c,d){b.hasVisibleChildren=b.isVisible||b.hasVisibleChildren;null!=d&&(d.hasVisibleChildren=d.hasVisibleChildren||b.hasVisibleChildren)});a.loopLevels(this,function(f,h){var i,s,H;if(!d&&!h.hasVisibleChildren)return a.SKIP;i=c.node(f);i||(i=p({visibility:4,connectorPlacement:0,parentId:null,actualItemType:0},h),c.add(null,f,i));S=R=0;if(null!=
